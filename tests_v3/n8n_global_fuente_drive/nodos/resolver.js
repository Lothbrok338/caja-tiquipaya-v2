...
// Defaults TIQUIPAYA: EXACTAMENTE los folder IDs historicos ya en uso (04_SALIDAS/SAP
// y 05_CONTROLES). Solo se usan si DRIVE_*_TIQ no esta definida. AMERICA: SIN
// defaults a proposito -- no existen carpetas reales todavia; falla cerrado.
const DEFAULTS_TIQ = {
...
const carpetaControlesId = resolverDestino('controles');
