...
// Payload para v3.dev_api (ejecutar_control3_institucional) -- Python es la
// unica autoridad. Opera SIEMPRE sobre AMBOS GLOBAL oficiales (TIQ+AME) y los
// historicos MAESTROS que este backend acaba de descargar de Drive a
// control3_institucional_entrada/<periodo>/ (nunca sobre archivos locales).
// CONTROL 3 es institucional: nunca recibe ni infiere `caja`. Cero logica
// contable aqui.
